...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="row">
            <h4 class="mb-3">Cadastro de aluno</h4>
            <form method="post" class="needs-validation" novalidate="" action="../../../model/aluno/adicionar-aluno.php">
                <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="nome">Aluno</label>
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome completo do aluno" value="" required="">
