...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="../">Gestão de Alunos</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="../gerenciador.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../disciplinas">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="btn-sm dropdown-item" href="cadastrar-disciplina.php">Disciplina</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody class="align-middle">
                            <?php foreach($data_professor as $row): ?>
                                <tr>
                                    <td>
                                        <?php echo $row['matricula_professor']; ?>
                                    </td>
                                    <td>
                                        <?php echo $row['nome']; ?>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-row-reverse">
                                            <input type="hidden" id="id_professor" name="id_professor" value="<?php echo $dado['id']; ?>">
                                            <a href="../professor/remover-professor.php?id=<?php echo ($row['id']);?>" type="button" class="btn btn-outline-danger btn-sm" onclick="removerProfessor()">Remover</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
