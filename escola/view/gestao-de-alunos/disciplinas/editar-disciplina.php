<?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM escola.disciplinas WHERE id = '$id'";
    ...
    <script>
        function removerDisciplina(){
            ...
            if (resposta == true){
                ...
                document.location.assign(`../../../model/disciplina/remover-disciplina.php?id=${id}`);
            }
        }
    </script>
</head>
...
<body class="bg-light">
    <div class="container">
        ...
        <div class="row">
            ...
            <form method="post" class="needs-validation" novalidate="" action="../../../model/disciplina/atualizar-disciplina.php">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="descricao" name="descricao" value="<?php echo $dado['descricao']; ?>" required=""></input>
                        <div class="invalid-feedback">
                ...
                <input class="btn btn-primary btn-lg btn-block" type="button" onclick="removerDisciplina()" value="Remover">
            </form>
        </div>
