<?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM escola.professores WHERE id = '$id'";
...
<head>
    ...
    <title>Escola - Editar Professor</title>
    ...
    <script>
        function removerProfessor(){
            ...
            if (resposta == true){
                ...
                document.location.assign(`../../../model/professor/remover-professor.php?id=${id}`);
            }
        }
    </script>
</head>
...
<body class="bg-light">
    <div class="container">
        ...
        <div class="row">
            ...
            <form method="post" class="needs-validation" novalidate="" action="../../../model/professor/atualizar-professor.php">
                <input type="hidden" id="id" name="id" value="<?php echo $dado['id']; ?>">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="nome">Professor</label>
                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome completo do professor" value="<?php echo $dado['nome']; ?>" required="">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="matricula" name="matricula" placeholder="Número da matrícula" value="<?php echo $dado['matricula_professor']; ?>" required="">
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="custom-control custom-radio">
                            <input id="masculino" name="genero" type="radio" class="custom-control-input" required="" checked="" value="1">
                            <label class="custom-control-label" for="masculino">Masculino</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input id="feminino" name="genero" type="radio" class="custom-control-input" required="" value="2">
                            <label class="custom-control-label" for="feminino">Feminino</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input id="outro" name="genero" type="radio" class="custom-control-input" required="" value="3">
                ...
                <input class="btn btn-primary btn-lg btn-block" type="button" onclick="removerProfessor()" value="Remover">
            </form>
        </div>
